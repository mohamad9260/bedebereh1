...
object IranLocationsData {
  ...
  val provincesWithCities: Map<String, List<String>> = mapOf(
    "تهران" to listOf("تهران", "شهریار", "اسلامشهر", "ورامین", "ری", "پردیس", "دماوند", "رباط‌کریم", "پاکدشت"),
    "اصفهان" to listOf("اصفهان", "کاشان", "خمینی‌شهر", "نجف‌آباد", "شاهین‌شهر", "فولادشهر", "مبارکه", "شهرضا"),
    "خراسان رضوی" to listOf("مشهد", "نیشابور", "سبزوار", "تربت حیدریه", "قوچان", "کاشمر", "گناباد"),
    "فارس" to listOf("شیراز", "مرودشت", "جهرم", "فسا", "کازرون", "لار", "داراب", "آباده"),
    "آذربایجان شرقی" to listOf("تبریز", "مراغه", "مرند", "میانه", "اهر", "بناب", "سراب"),
    "البرز" to listOf("کرج", "فردیس", "کمال‌شهر", "نظرآباد", "محمدشهر", "هشتگرد"),
    "خوزستان" to listOf("اهواز", "دزفول", "آبادان", "خرمشهر", "ماهشهر", "شوشتر", "اندیمشک"),
    "قم" to listOf("قم", "قنوات", "جعفریه", "کهک"),
    "گیلان" to listOf("رشت", "بندر انزلی", "لاهیجان", "لنگرود", "تالش", "فومن", "آستارا"),
    "مازندران" to listOf("ساری", "بابل", "آمل", "قائم‌شهر", "بابلسر", "چالوس", "تنکابن", "نوشهر"),
    "کرمانشاه" to listOf("کرمانشاه", "اسلام‌آباد غرب", "کنگاور", "جوانرود", "سنقر"),
    "آذربایجان غربی" to listOf("ارومیه", "خوی", "بوکان", "مهاباد", "میاندوآب"),
    "یزد" to listOf("یزد", "میبد", "اردکان", "بافق", "مهریز"),
    "کرمان" to listOf("کرمان", "سیرجان", "رفسنجان", "جیرفت", "بم"),
    "مرکزی" to listOf("اراک", "ساوه", "خمین", "محلات", "دلیجان"),
    "هرمزگان" to listOf("بندرعباس", "قشم", "کیش", "میناب", "بندرلنگه"),
    "همدان" to listOf("همدان", "ملایر", "نهاوند", "تویسرکان", "کبودرآهنگ"),
    "قزوین" to listOf("قزوین", "الوند", "تاکستان", "محمدیه", "بوئین‌زهرا"),
    "کردستان" to listOf("سنندج", "سقز", "مریوان", "بانه", "قروه")
  )
